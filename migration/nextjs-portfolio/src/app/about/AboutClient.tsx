...
// Import images - use static paths for Next.js
const headshot = '/img/headshot.webp';
const design = '/img/design.webp';
const dev = '/img/dev.webp';
const designthinking = '/img/designthinking.webp';

// Custom focus trap hook to match original functionality
  ...
  return (
    <div className="About Page">
      <section className="non-contrast-section hero" style={{ position: 'relative' }}>
        ...
        <h2>User-centered thinking meets measurable impact.</h2>          <div className="info-group">
        ...
        <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center', flexWrap: 'wrap' }}>
          ...
          <button
            ...
            onMouseEnter={(e) => {
              ...
              target.style.background = 'var(--accent-color, #005A9C)';
            ...
            onMouseLeave={(e) => {
              ...
              target.style.color = 'var(--accent-color, #005A9C)';
